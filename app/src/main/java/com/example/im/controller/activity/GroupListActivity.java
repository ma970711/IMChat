            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(GroupListActivity.this,"好像出了一些问题，正在自动修复中",Toast.LENGTH_SHORT).show();
                        }
                    });
                    return;
                }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(GroupListActivity.this,"加载群信息失败，原因"+e.toString(),Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
